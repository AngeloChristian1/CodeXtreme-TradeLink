...
function OurProcessSection() {
  ...
  return (
    ...
    <div className='w-full flex flex-col items-center justify-center '>
        ...
        <div className='my-4 w-[50%]'><p className='text-base text-grey text-center'>Producer Connect is your partner in digital innovation. We fuse strategic thinking with standout design and development to deliver uniquely tailored solutions.</p></div>
